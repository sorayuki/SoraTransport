...
struct PipelineTuning {
	...
	std::size_t directory_traversal_concurrency = 32;
	std::size_t file_open_concurrency = 128;
	std::size_t file_prefetch_budget_bytes = 64 * 1024 * 1024;
	std::size_t tar_output_budget_bytes = 64 * 1024 * 1024;
	std::size_t zstd_output_budget_bytes = 64 * 1024 * 1024;
	std::size_t opened_queue_capacity = 128;
	std::size_t prefetched_queue_capacity = 64;
	std::size_t tar_queue_capacity = 16;
	std::size_t zstd_queue_capacity = 16;
